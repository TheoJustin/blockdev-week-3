...
const TableRow = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
  ({ className, ...props }, ref) => (
    <tr className={cn("border-b border-border/70 transition-colors hover:bg-muted/50", className)} ref={ref} {...props} />
  ),
);
...
const TableCell = React.forwardRef<HTMLTableCellElement, React.TdHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => <td className={cn("p-4 align-middle", className)} ref={ref} {...props} />,
);
